...
(function () {
  ...
  if (typeof TextToIPA._parseDict !== "function") {
    TextToIPA._parseDict = function (lines) {
      ...
      if (TextToIPA._callback instanceof Function) {
        TextToIPA._callback();
      }
    };
  }
  ...
  if (typeof TextToIPA.loadDict !== "function") {
    TextToIPA.loadDict = function (location, callback) {
      TextToIPA._callback = callback;
    ...
    TextToIPA.lookup = function (word) {
      if (Object.keys(TextToIPA._IPADict).length === 0) {
        ...
        if (typeof TextToIPA._IPADict[word] != "undefined") {
          ...
          if (typeof TextToIPA._IPADict[word + "(1)"] != "undefined") {
            //IF THERE'S MORE THAN ONE PRONUNCIATION, USE (1)
